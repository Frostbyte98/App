...
public class Leaderboard : MonoBehaviour
{
    ...
    const string privateCode2 = "lGal9TVnDEuUL-wdAqaDzgxIAtdqd7CkyVneFeQlnsmQ";
    const string publicCode2 = "5ede055d377dce0a148c4c98";
    ...
    IEnumerator UploadNewHighscore(string username, int score)
    {
        ...
        {
            UnityWebRequest www = UnityWebRequest.Get(webURL + privateCode2 + "/add/" + UnityWebRequest.EscapeURL(username) + "/" + score);
            yield return www.SendWebRequest();
    ...
    IEnumerator DownloadHighscore()
    {
        ...
        if (SceneManager.GetActiveScene().buildIndex == 2)
        {
            UnityWebRequest www = UnityWebRequest.Get(webURL + publicCode2 + "/pipe/100");
            yield return www.SendWebRequest();
